...
report['summary'] = (
    ...
    "autonomous detection and response. Services and capability maturity operates as a cross-cutting "
...
report['findings'] = [
    {
        ...
        "body": (
            ...
            "simulation before weapons reach their targets. Autonomous detection and response covers "
            ...
            "against Initial Access (TA0001) and Privilege Escalation (TA0004), and autonomous detection "
            "and response covers Execution (TA0002) through Impact (TA0040). Services and capability "
    ...
    },
    {
        ...
        "body": (
            ...
            "reactive bias. Autonomous detection and response capabilities map primarily to Phases 4 "
    ...
    },
    {
        ...
        "body": (
            ...
            "and Privilege Escalation (TA0004). Autonomous detection and response covers Execution "
...
report['analysis_sections'] = [
    {
        ...
        "body": (
            ...
            "Autonomous detection and response provides deception, threat hunting, counter-adversary "
    ...
    },
    {
        ...
        "body": (
            ...
            "In the late phases, autonomous detection and response provides coverage through threat "
    ...
    },
    {
        ...
        "body": (
            ...
            "Execution (TA0002) and Persistence (TA0003) are well-covered by autonomous detection "
            "and response capabilities including endpoint detection, behavioral analytics, and threat "
            "hunting.\n\n"
            ...
            "(TA0040) are covered by autonomous detection and response capabilities, placing them "
...
report['background'] = (
    ...
    "Autonomous Detection and Response) and a cross-cutting enablement layer (Services and "
...
report['conclusion'] = (
    ...
    "validation but undermined by a critical adversary management gap; autonomous detection and "
...
report['glossary'] = [
    ...
    {
        "term": "Autonomous Detection and Response",
